...
namespace DBFirstTest1 {
    ...
    public partial class Rewards2DataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_CustomerPurchase;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_CustomerPurchase = this.Relations["FK_CustomerPurchase"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_CustomerPurchase = new global::System.Data.DataRelation("FK_CustomerPurchase", new global::System.Data.DataColumn[] {
                        this.tableCustomers.IdColumn}, new global::System.Data.DataColumn[] {
                        this.tablePurchases.CustomerIdColumn}, false);
            this.Relations.Add(this.relationFK_CustomerPurchase);
        }
        ...
        public partial class PurchasesDataTable : global::System.Data.TypedTableBase<PurchasesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PurchasesRow AddPurchasesRow(System.DateTime PurchaseDate, decimal Amount, CustomersRow parentCustomersRowByFK_CustomerPurchase) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        Amount,
                        null};
                if ((parentCustomersRowByFK_CustomerPurchase != null)) {
                    columnValuesArray[3] = parentCustomersRowByFK_CustomerPurchase[0];
                }
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public PurchasesRow[] GetPurchasesRows() {
                if ((this.Table.ChildRelations["FK_CustomerPurchase"] == null)) {
                    return new PurchasesRow[0];
                }
                else {
                    return ((PurchasesRow[])(base.GetChildRows(this.Table.ChildRelations["FK_CustomerPurchase"])));
                }
            }
        }
        ...
        public partial class PurchasesRow : global::System.Data.DataRow {
            ...
            public CustomersRow CustomersRow {
                get {
                    return ((CustomersRow)(this.GetParentRow(this.Table.ParentRelations["FK_CustomerPurchase"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_CustomerPurchase"]);
                }
            }
        }
...
namespace DBFirstTest1.Rewards2DataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBFirstTest1.Properties.Settings.Default.Rewards2ConnectionString;
        }
    ...
    public partial class PurchasesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Purchases] WHERE (([Id] = @Original_Id) AND ([PurchaseDate] = " +
                "@Original_PurchaseDate) AND ([Amount] = @Original_Amount) AND ([CustomerId] = @O" +
                "riginal_CustomerId))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Purchases] ([PurchaseDate], [Amount], [CustomerId]) VALUES (@P" +
                "urchaseDate, @Amount, @CustomerId);\r\nSELECT Id, PurchaseDate, Amount, CustomerId" +
                " FROM Purchases WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Purchases] SET [PurchaseDate] = @PurchaseDate, [Amount] = @Amount, [CustomerId] = @CustomerId WHERE (([Id] = @Original_Id) AND ([PurchaseDate] = @Original_PurchaseDate) AND ([Amount] = @Original_Amount) AND ([CustomerId] = @Original_CustomerId));
SELECT Id, PurchaseDate, Amount, CustomerId FROM Purchases WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, PurchaseDate, Amount, CustomerId FROM dbo.Purchases";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, System.DateTime Original_PurchaseDate, decimal Original_Amount, int Original_CustomerId) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.DateTime PurchaseDate, decimal Amount, int CustomerId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime PurchaseDate, decimal Amount, int CustomerId, int Original_Id, System.DateTime Original_PurchaseDate, decimal Original_Amount, int Original_CustomerId, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime PurchaseDate, decimal Amount, int CustomerId, int Original_Id, System.DateTime Original_PurchaseDate, decimal Original_Amount, int Original_CustomerId) {
            return this.Update(PurchaseDate, Amount, CustomerId, Original_Id, Original_PurchaseDate, Original_Amount, Original_CustomerId, Original_Id);
        }
    }
